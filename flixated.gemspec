...
Gem::Specification.new do |s|
  ...
  s.files = [
    "lib/flixated.rb",
    "lib/flixated/catalog.rb",
    "lib/flixated/client.rb",
    "lib/flixated/utils.rb",
    "lib/flixated/version.rb"
  ]
  s.homepage = %q{http://github.com/anthonator/flixated}
  s.licenses = ["MIT"]
  s.require_paths = ["lib"]
  s.rubygems_version = %q{1.4.2}
  s.summary = %q{Netflix OAuth REST API client library for Ruby}
  s.test_files = [
    "spec/flixated_spec.rb",
    "spec/spec_helper.rb"
  ]
